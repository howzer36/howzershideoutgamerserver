...
local quickKeyPages = 9 -- Default number of quick key pages.
local macroHotKeysCount = 9 -- Default number of hotkey macros.
...
local enableHotkeyPortion = true -- If true, enables the hotkey/macro portions of this script.
